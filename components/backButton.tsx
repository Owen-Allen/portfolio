...
export default function BackButton() {
    ...
    return (
        <button type="button" onClick={() => router.push('/projects')} className="rounded-full w-12 flex items-center justify-center sm:px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border gap-x-2 sm:w-auto hover:bg-gray-100">
