...
export default function iMessageAssistant() {
    return (
        <div className="px-2 w-full flex flex-col justify-center items-center">
            ...
            <div className="flex w-full sm:w-10/12 flex-row items-end space-x-8 sm:justify-normal m-10">
                <BackButton />
                <Link className="text-2xl sm:text-3xl font-bold" href="/photo-notes"> iMessage Assistant </Link>
                <Link className="text-lg sm:text-2xl" href="https://github.com/Owen-Allen/imessage-assistant"> Github </Link>
            </div>
            <div className="relative flex flex-col-reverse sm:flex-row w-full sm:w-10/12">
                ...
                <section className="w-full flex flex-col p-8  bg-white rounded-lg shadow-lg"> {/* WHEN VIDEO ADDED, ADD sm:w-2/3 */}
                    <h2 className="text-2xl">
                        Project Description
                    </h2>
                    <p>Coming soon. See github for more info.</p>
                    {/* <p className="py-4">
