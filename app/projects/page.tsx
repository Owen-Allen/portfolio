                ...
                <SimpleGrid className="xl:w-2/3 lg:w-3/4 w-full " columns={{ sm: 1, md: 2 }} spacing={8}>
                    ...
                    >
                        <CardBody className="flex flex-col">
                            <Link href='/imessageassistant' className='w-full'>
                                <div className="w-full flex justify-center rounded-lg">
                                    <Image priority width={120} height={120} src='/openai.png' alt='OpenAI logo'   className='p-4  mb-auto block' /> 
                                    <Image priority width={120} height={120} src='/imessage.png' alt='iMessage logo' className='p-4  mb-auto block' />
                                </div>
                            </Link>
                            <div className="mt-6 flex flex-row items-center">
                                <Link className="text-xl font-bold" href="/imessageassistant"> iMessage Assistant </Link>
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://github.com/Owen-Allen/imessage-assistant"> Github </Link>
                            </div>
                        ...
                        <Link href="https://www.python.org/" className="flex flex-col justify-center items-center">
                            ...
                            <Icon href="https://www.sqlite.org/index.html" className="devicon-sqlite-plain colored text-4xl" > <p className="pt-1 text-xs font-semi">SQLite</p></Icon>
                            <Link href="https://openai.com/" className="flex flex-col justify-center items-center">
                                <Image priority width={36} height={36} src='/openai.png' alt='OpenAI logo'   className='' /> 
                                <p className='pt-1 text-xs font-semi'>OpenAI</p>
                            </Link>
                        </CardFooter>
                    </Card>
                    ...
                    >
                        <CardBody className="flex flex-col">
                            <Link href='/clucker' className='w-full'>
                                <div className="shadow-md w-full flex justify-center rounded-lg bg-sky-400">
                            ...
                            <div className="mt-6 flex flex-row items-center">
                                ...
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://github.com/Owen-Allen/clucker"> Github </Link>
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://clucker.vercel.app/"          > Website </Link>
                            </div>
                            <Text className="mt-4 break-words">
                    ...
                    <Card className="flex flex-col items-center justify-center" boxShadow="lg" overflow="hidden">
                        <CardBody className="flex flex-col p-4">
                            <Link href="/bookstore-web-app" className="w-full">
                                <div className="shadow-md w-full flex justify-center rounded-lg bg-orange-300">
                            ...
                            <div className="mt-6 flex flex-row items-center">
                                ...
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://github.com/Owen-Allen/bookstore-webapp">
                                    Github
                                </Link>
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://bookstore-webapp.vercel.app/">
                                    Website
                                </Link>
                            </div>
                            <Text className="mt-4">
                    ...
                    >
                        <CardBody id="photo-notes" className="flex flex-col">
                            ...
                            <div className="mt-6 flex flex-row items-center">
                                ...
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://github.com/Owen-Allen/photo-notes">Github</Link>
                            </div>
                            {/* BODY */}
                            <Text className="mt-4">
                    ...
                    >
                        <CardBody id="restaurantapp" className="flex flex-col">
                            ...
                            <div className="mt-6 flex flex-row items-center">
                                ...
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://github.com/Owen-Allen/restaurant-app">Github</Link>
                                <Link className="mt-0.5 ml-4 hover:underline" href="https://restaurant-app-e9w4.onrender.com/"> Website </Link>
                            </div>
                            {/* BODY */}
                            <Text className="mt-4">
