        ...
        <div className="w-full flex flex-col justify-center items-center">
            ...
            <div className="relative flex flex-col-reverse sm:flex-row w-full sm:w-10/12">
                ...
                <SimpleGrid className="px-4" columns={{ sm: 1, md: 2 }} spacing={2}>
                    ...
                    <Link href="/clucker/login.jpg"><Image className="rounded-md" src="/clucker/login.jpg" width={200} height={240} alt="Clucker login" /></Link>
                    <Link href="/clucker/feed.jpg"><Image className="rounded-md" src="/clucker/feed.jpg" width={200} height={240} alt="Clucker feed" /></Link>
                    <Link href="/clucker/cluck.jpg"><Image className="rounded-md" src="/clucker/cluck.jpg" width={200} height={240} alt="Clucker cluck" /></Link>
                    <Link href="/clucker/profile.jpg"><Image className="rounded-md" src="/clucker/profile.jpg" width={200} height={240} alt="Clucker profile" /></Link>
